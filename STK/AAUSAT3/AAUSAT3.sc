...
BEGIN Scenario
    ...
    BEGIN Epoch
        ...
        Epoch		 7 Dec 2020 15:00:00.000000000
        SmartEpoch		
        BEGIN EVENT
            Epoch		 7 Dec 2020 15:00:00.000000000
            EventEpoch		
    ...
    BEGIN Interval
        ...
        Start		 7 Dec 2020 15:00:00.000000000
        Stop		 8 Dec 2020 15:00:00.000000000
        SmartInterval		
        BEGIN EVENTINTERVAL
            BEGIN Interval
                Start		 7 Dec 2020 15:00:00.000000000
...
<SCOPE>
    ...
    <VAR name = "ActiveCommSystem">
        ...
        BEGIN Graphics
            ...
            BEGIN Animation
                ...
                StartTime		 7 Dec 2020 15:00:00.000000000
                EndTime		 8 Dec 2020 15:00:00.000000000
                CurrentTime		 7 Dec 2020 17:17:50.000000000
                Direction		 Forward
                UpdateDelta		 10
            ...
            BEGIN MapData
                ...
                BEGIN Map
                    ...
                    BEGIN MapAttributes
                        PrimaryBody		 Earth
                        SecondaryBody		 Sun
                        CenterLatitude		 0.6818181818181819
                        CenterLongitude		 22.41509433962259
                        ...
                        BEGIN ZoomLocations
                            BEGIN ZoomLocation
                                CenterLat		 0.6818181818181819
                                CenterLon		 22.41509433962259
                                ZoomWidth		 360
                                ZoomHeight		 180
                            END ZoomLocation
                        END ZoomLocations
    ...
    BEGIN References
        Instance *
            *		
        END Instance
        Instance Satellite/AAUSAT-III
            *		
            Satellite/AAUSAT-III		
        END Instance
    END References
